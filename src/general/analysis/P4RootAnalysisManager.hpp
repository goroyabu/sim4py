/**
   @file    P4RootAnalysisManager.hpp
   @author  Goro Yabu
   @date    2020/02/04
**/

#ifndef P4RootAnalysisManager_hpp
#define P4RootAnalysisManager_hpp
...
public:
    ...
    explicit P4RootAnalysisManager();
    ~P4RootAnalysisManager();

    static P4RootAnalysisManager* Instance();
...
private:
    ...
    static P4RootAnalysisManager* P4RootAnalysisManagerInstance;
