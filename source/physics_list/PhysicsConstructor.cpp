...
PhysicsConstructor::PhysicsConstructor(G4int ver, const G4String& comp, bool doppler)
    : G4VPhysicsConstructor("PhysicsConstructor"), verbose(ver),
      compton_model(comp), is_enabled_livermore_compton(doppler)
{
    std::cout << "PhysicsConstructor::PhysicsConstructor" << compton_model << " " << is_enabled_livermore_compton << std::endl;
    G4EmParameters* param = G4EmParameters::Instance();
    param->SetDefaults();
    param->SetVerbose(verbose);
    param->SetMinEnergy(100*eV);
...
void PhysicsConstructor::ConstructProcess()
{
    ...
    std::cout << "PhysicsConstructor::ConstructProcess() " << compton_model << " " << is_enabled_livermore_compton << std::endl;
